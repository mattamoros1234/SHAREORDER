            ...
            public TableCell<Pacco, Void> call(final TableColumn<Pacco, Void> param) {
                ...
                final TableCell<Pacco, Void> cell = new TableCell<Pacco, Void>() {
...

                    {
                        btn.setOnAction((ActionEvent event) -> {
                            Pacco paccoTemp = getTableView().getItems().get(getIndex());
                            if(paccoTemp.getEmailDestinatario().equals(Main.getEmailAttiva())) {
                            	System.out.println("modify acessibile per te");
                            	try {
									root = FXMLLoader.load(getClass().getResource("ModificaPacco.fxml"));
								} catch (IOException e) {
									// TODO Auto-generated catch block
									e.printStackTrace();
								}
                            	...
                            	System.out.println("modify non acessibile per te, sei il propietario");
                            }
                        });
                    }
